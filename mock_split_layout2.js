...
// Find the start of the content wrapper using regex
...
if (!match) {
  console.log("Could not match wrapper");
  process.exit(1);
}

// We need to split properly. It's better to just extract the whole component and rewrite it.
...
if (!logoCode || !titlesCode || !actionsCode) {
    ...
    console.log("Logo:", !!logoCode);
    console.log("Titles:", !!titlesCode);
    console.log("Actions:", !!actionsCode);
    process.exit(1);
}
