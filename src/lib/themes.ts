...
export const gangThemes: Record<GangTheme, { name: string; description: string; preview: string; accent: string; background: string; className: string }> = {
  ...
  mono: { name: "Theme Winterfell", description: "มินิมอล คม และสะอาด", preview: "linear-gradient(135deg,#303030,#0b0b0b)", accent: "#ffffff", background: "#0b0b0b", className: "theme-mono" },
