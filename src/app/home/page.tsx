...
const packages = [
  ...
  { name: "เอมไพร์", price: "89฿", detail: "พื้นที่เต็มรูปแบบสำหรับแก๊งที่ต้องการขยายตัว", features: ["สมาชิกไม่จำกัด", "ลูกเล่นบนเว็บ และ Theme Premium มากมาย ที่ไม่เหมือนใคร", "รองรับระบบ PARTNER แก๊ง", "ต่อสัญญาอัตโนมัติ (ไม่มีวันหมดอายุ)"], featured: true },
];
