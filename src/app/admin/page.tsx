...
export default async function AdminDashboard() {
  ...
  return <div className="space-y-7">
    <section className="relative overflow-hidden rounded-[30px] border border-[#65b8f0]/25 bg-[linear-gradient(135deg,#101e2b,#0c1118_58%,#1a1425)] p-6 sm:p-8">
      ...
      <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-end"><div><p className="flex items-center gap-2 text-[10px] font-[900] tracking-[1.5px] text-[#91ceff]"><span className="size-2 rounded-full bg-[#66dfa0] shadow-[0_0_10px_#66dfa0]" /> เว็บไซต์ออนไลน์</p><h2 className="mt-5 max-w-[650px] text-[32px] font-[900] leading-[1.12] text-white sm:text-[46px]">สวัสดี, {gang.pageTitle}</h2><p className="mt-4 max-w-[520px] text-[12px] leading-[1.8] text-[#9eafbf]">ศูนย์จัดการเว็บไซต์และรายชื่อสมาชิกของคุณ พร้อมให้ปรับแต่งได้ทุกเวลา</p></div><a href={getGangUrl(gang.subdomain)} target="_blank" rel="noreferrer" className="flex shrink-0 items-center justify-center gap-2 rounded-2xl bg-[#dceeff] px-5 py-3.5 text-[11px] font-[900] text-[#0b3150] transition hover:bg-white">เปิดเว็บไซต์ <ExternalLink className="size-4" /></a></div>
      <div className="relative mt-8 flex flex-wrap gap-2"><span className="rounded-full border border-white/10 bg-black/15 px-3 py-2 text-[10px] text-[#b8c8d6]">{gang.subdomain}.lastname.site</span><span className="rounded-full border border-[#65dfa0]/20 bg-[#65dfa0]/10 px-3 py-2 text-[10px] text-[#8debb2]">พร้อมเผยแพร่</span></div>
    </section>
